...
class ResNet(nn.Layer):
    ...
    def get_1x_lr_params_NOscale(self):
        ...
        params_list = list()
        # params = list()
        params_list.append(self.conv1.parameters() +
                           self.bn1.parameters() +
        ...
        # params_list.append(self.conv1.parameters())
        # params_list.append(self.bn1.parameters())
        # params_list.append(self.layer1.parameters())
        # params_list.append(self.layer2.parameters())
        # params_list.append(self.layer3.parameters())
        # params_list.append(self.layer4.parameters())
        # params.append({'params': params_list, 'learning_rate':1.0})
    ...
    def get_10x_lr_params(self):
        ...
        """
        # params = list()
        # params.append({'params': self.layer5.parameters(), 'learning_rate':10.0})
        return self.layer5.parameters()

    def optim_parameters(self, args):
        optim_params = ({'params': self.get_1x_lr_params_NOscale(), 'learning_rate': 1.0},
                        {'params': self.get_10x_lr_params(), 'learning_rate': 10.0})
        return optim_params
